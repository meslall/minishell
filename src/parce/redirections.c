...
void	fill_heredoc(t_list *exec, t_token **token)
{
	...
	((t_data *)exec->content)->hd = (char **)ft_2d_realloc((void **)(((t_data *)exec->content)->hd),len_2d_array((void **)(((t_data *)exec->content)->hd)) + 1);
	((t_data *)exec->content)->hd[len_2d_array((void **)(((t_data *)exec->content)->hd))] = ft_strdup((*token)->value);
}
...
void	fill_outfile(t_list *exec, t_token *token)
{
	...
	((t_data *)exec->content)->outfiles[len_2d_array((void **)(((t_data *)exec->content)->outfiles))] = ft_strdup(token->value);
}
...
void	fill_append(t_list *exec, t_token *token)
{
	...
	((t_data *)exec->content)->append[len_2d_array((void **)(((t_data *)exec->content)->append))] = ft_strdup(token->value);
}
